...
export default function AboutMe() {
  return (
    <section
      id="about"
      className="mt-16 px-4 md:px-10 scroll-mt-52 md:scroll-mt-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center"
    >
      {/* Left Image */}
      <motion.div
      ...
      >
        ...
        <p className="text-gray-300 leading-relaxed mb-3">
          ...
          sharpen my skills. Since then, I’ve built multiple projects, mastered
          core web technologies, and developed a love for creating clean,
        ...
        <p className="text-gray-300 leading-relaxed">
          ...
          keeps me focused and energized. With curiosity as my guide and code as
          my tool, I’m always ready to take on new challenges and create
